...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Base.FieldSubmission", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("FieldSubmission");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Base.FieldTypes.InputField", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("InputField");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Base.FieldRestrictions.InputDate", b =>
                {
                    b.HasBaseType("Domain.Entities.Base.FieldTypes.InputField");

                    b.Property<int>("InputFieldId")
                        .HasColumnType("integer")
                        .HasColumnName("InputDate_InputFieldId");
                    ...
                    b.HasDiscriminator().HasValue("InputDate");
                });

            modelBuilder.Entity("Domain.Entities.Base.FieldRestrictions.InputNumber", b =>
                {
                    b.HasBaseType("Domain.Entities.Base.FieldTypes.InputField");

                    b.Property<int>("InputFieldId")
                        .HasColumnType("integer")
                        .HasColumnName("InputNumber_InputFieldId");
                    ...
                    b.HasDiscriminator().HasValue("InputNumber");
                });

            modelBuilder.Entity("Domain.Entities.Base.FieldRestrictions.InputNumberPhone", b =>
                {
                    b.HasBaseType("Domain.Entities.Base.FieldTypes.InputField");

                    b.Property<int>("InputFieldId")
                        .HasColumnType("integer")
                        .HasColumnName("InputNumberPhone_InputFieldId");
                    ...
                    b.HasDiscriminator().HasValue("InputNumberPhone");
                });

            modelBuilder.Entity("Domain.Entities.Base.FieldRestrictions.InputText", b =>
                {
                    b.HasBaseType("Domain.Entities.Base.FieldTypes.InputField");
                    ...
                    b.HasDiscriminator().HasValue("InputText");
                });

            modelBuilder.Entity("Domain.Entities.Base.FieldSubmissions.InputSubmission", b =>
                {
                    b.HasBaseType("Domain.Entities.Base.FieldSubmission");
                    ...
                    b.HasDiscriminator().HasValue("InputSubmission");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Base.FieldSubmissions.SelectSubmission", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("SelectSubmission");
                });
