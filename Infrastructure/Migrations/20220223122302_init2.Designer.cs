...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20220223122302_init2")]
    partial class init2
    {
            ...
            modelBuilder.Entity("Domain.Entities.Base.FieldRestrictions.InputDate", b =>
                {
                    b.HasOne("Domain.Entities.Base.FieldTypes.InputField", null)
                        .WithOne()
                        .HasForeignKey("Domain.Entities.Base.FieldRestrictions.InputDate", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Base.FieldRestrictions.InputNumber", b =>
                {
                    b.HasOne("Domain.Entities.Base.FieldTypes.InputField", null)
                        .WithOne()
                        .HasForeignKey("Domain.Entities.Base.FieldRestrictions.InputNumber", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Base.FieldRestrictions.InputNumberPhone", b =>
                {
                    b.HasOne("Domain.Entities.Base.FieldTypes.InputField", null)
                        .WithOne()
                        .HasForeignKey("Domain.Entities.Base.FieldRestrictions.InputNumberPhone", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Base.FieldRestrictions.InputText", b =>
                {
                    b.HasOne("Domain.Entities.Base.FieldTypes.InputField", null)
                        .WithOne()
                        .HasForeignKey("Domain.Entities.Base.FieldRestrictions.InputText", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
